...
internal class Lesson9
{
    ...
    /* Private access modifier can only be seen withing the class, struct, or nested type */
    ...
    /*
     Protected Internal can be seen within the assembly or child derived class from another
    assembly.
     */
