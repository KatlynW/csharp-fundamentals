...
public enum Day { Sat, Sun, Mon, Teu, Wed, Thur, Fri}
...
internal class Lesson15
{
    public void EnumExample()
    {
        ...
        Console.WriteLine((double) Day.Teu); // displays number value
    }

    // Enum using a switch expression is narrow down choices
    ...
    /*
     Tuples are a group of types using parentheses and separating with a comma
     */
